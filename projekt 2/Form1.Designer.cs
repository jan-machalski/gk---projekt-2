namespace projekt_2
{
    partial class Form1
    {
		...
		private void InitializeComponent()
		{
			...
			pictureBox1.Size = new Size(1332, 1045);
			...
			fileDialogButton.Location = new Point(1368, 50);
			...
			accuracyTrackBar.Location = new Point(1358, 150);
			...
			label1.Location = new Point(1375, 120);
			...
			zTurnTrackBar.Location = new Point(1358, 259);
			...
			label3.Location = new Point(1385, 229);
			...
			label4.Location = new Point(1596, 259);
			...
			xTurnTrackBar.Location = new Point(1357, 369);
			...
			label5.Location = new Point(1385, 339);
			...
			label6.Location = new Point(1596, 369);
			...
			kdTrackBar.Location = new Point(1358, 492);
			...
			label7.Location = new Point(1375, 462);
			...
			ksTrackBar.Location = new Point(1358, 602);
			...
			label9.Location = new Point(1368, 572);
			...
			mTrackBar.Location = new Point(1375, 742);
			...
			label11.Location = new Point(1368, 694);
			...
			label12.Location = new Point(1589, 751);
			...
			lightColorButton.Location = new Point(1636, 93);
			...
			lightColorPanel.Location = new Point(1761, 93);
			...
			surfaceColorButton.Location = new Point(1629, 279);
			...
			surfaceColorPanel.Location = new Point(1761, 280);
			...
			chooseImageButton.Location = new Point(1633, 503);
			...
			colorStructureRadioButton.Location = new Point(1674, 638);
			...
			label13.Location = new Point(1664, 608);
			...
			ImageRadioButton.Location = new Point(1667, 680);
			...
			normalMapCheckBox.Location = new Point(1696, 821);
			...
			// loadNormalButton
			// 
			loadNormalButton.Location = new Point(1633, 716);
			...
			drawTrianglesCheckBox.Location = new Point(1638, 397);
			...
			fillTrianglesCheckBox.Location = new Point(1640, 438);
			...
			lightMoveButton.Location = new Point(1636, 199);
			lightMoveButton.Margin = new Padding(4, 5, 4, 5);
			lightMoveButton.Name = "lightMoveButton";
			lightMoveButton.Size = new Size(230, 67);
			...
			picturePanel.Location = new Point(1761, 505);
			...
			// normalMapPanel
			// 
			normalMapPanel.Location = new Point(1761, 716);
			...
			lightSourceTrackBar.Location = new Point(1378, 855);
			...
			lightSourceTrackBar.TickFrequency = 10;
			...
			label14.Location = new Point(1385, 815);
